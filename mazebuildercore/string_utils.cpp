...
bool string_utils::find(const std::string_view sv, const char c) noexcept
{
...
std::string_view string_utils::find_first_of(const std::string_view& s, const std::string_view& chars) noexcept
{
    ...
    const auto pos = s.find_first_of(chars);
...
std::string string_utils::format(const std::string_view format_str, const Args&... args) noexcept
{
...
template <>
std::string string_utils::format<>(const std::string_view format_str) noexcept
{
    return fmt::vformat(format_str, fmt::make_format_args());
}

template <>
std::string string_utils::format<std::int32_t>(const std::string_view format_str, const std::int32_t& arg) noexcept
{
...
template <>
std::string string_utils::format<int, int>(const std::string_view format_str, const int& arg1, const int& arg2) noexcept
{
...
std::string string_utils::format<int, size_t, size_t, size_t>(const std::string_view format_str, const int& arg,
                                                              const size_t& arg2, const size_t& arg3,
                                                              const size_t& arg4) noexcept
{
    return fmt::vformat(format_str, fmt::make_format_args(arg, arg2, arg3, arg4));
}
...
template <>
std::string string_utils::format<float, float>(const std::string_view format_str, const float& arg1,
                                               const float& arg2) noexcept
{
    return fmt::vformat(format_str, fmt::make_format_args(arg1, arg2));
}
...
template <>
std::string string_utils::format<std::string_view>(const std::string_view format_str, const std::string_view& arg1,
                                                   const std::string_view& arg2, const std::string_view& arg3,
                                                   const std::string_view& arg4,
...
template <>
std::string string_utils::format<std::string, const char*>(std::string_view format_str, const std::string& arg1,
                                                           const char* const & arg2) noexcept
{
    return fmt::vformat(format_str, fmt::make_format_args(arg1, arg2));
}
...
template <>
std::string string_utils::format<const char*, std::string>(std::string_view format_str, const char* const & arg1,
                                                           const std::string& arg2) noexcept
{
    return fmt::vformat(format_str, fmt::make_format_args(arg1, arg2));
}
